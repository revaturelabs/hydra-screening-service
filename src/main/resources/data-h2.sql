...
insert into SCHEDULED_SCREENING (trainee, status, scheduled_date) values (5501, 'SCREENED', (SYSDATE+13));
insert into SCHEDULED_SCREENING (trainee, status, scheduled_date) values (5502, 'SCREENED', (SYSDATE+17));
insert into SCHEDULED_SCREENING (trainee, status, scheduled_date) values (5503, 'SCREENED', (SYSDATE+2));
insert into SCHEDULED_SCREENING (trainee, status, scheduled_date) values (5504, 'PENDING', (SYSDATE+6));
insert into SCHEDULED_SCREENING (trainee, status, scheduled_date) values (5505, 'SCREENED', (SYSDATE+35));
insert into SCHEDULED_SCREENING (trainee, status, scheduled_date) values (5506, 'PENDING', (SYSDATE+6));
insert into SCHEDULED_SCREENING (trainee, status, scheduled_date) values (5507, 'PENDING', (SYSDATE+1));
insert into SCHEDULED_SCREENING (trainee, status, scheduled_date) values (5508, 'PENDING', (SYSDATE+13));
insert into SCHEDULED_SCREENING (trainee, status, scheduled_date) values (5509, 'SCREENED', (SYSDATE+4));
insert into SCHEDULED_SCREENING (trainee, status, scheduled_date) values (5510, 'PENDING', (SYSDATE+9));
insert into SCHEDULED_SCREENING (trainee, status, scheduled_date) values (5511, 'SCREENED', (SYSDATE+12));
insert into SCHEDULED_SCREENING (trainee, status, scheduled_date) values (5512, 'SCREENED', (SYSDATE+11));
insert into SCHEDULED_SCREENING (trainee, status, scheduled_date) values (5513, 'PENDING', (SYSDATE+9));
insert into SCHEDULED_SCREENING (trainee, status, scheduled_date) values (5514, 'SCREENED', (SYSDATE+3));
insert into SCHEDULED_SCREENING (trainee, status, scheduled_date) values (5515, 'PENDING', (SYSDATE+8));
insert into SCHEDULED_SCREENING (trainee, status, scheduled_date) values (5516, 'PENDING', (SYSDATE+2));
insert into SCHEDULED_SCREENING (trainee, status, scheduled_date) values (5517, 'PENDING', (SYSDATE+19));
insert into SCHEDULED_SCREENING (trainee, status, scheduled_date) values (5518, 'SCREENED', (SYSDATE+24));
insert into SCHEDULED_SCREENING (trainee, status, scheduled_date) values (5519, 'SCREENED', (SYSDATE+20));
insert into SCHEDULED_SCREENING (trainee, status, scheduled_date) values (5520, 'SCREENED', (SYSDATE+1));
